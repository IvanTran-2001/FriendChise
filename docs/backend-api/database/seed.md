...
- If you need the exact model layout, see [Data Models](/doc/backend-api/database/models).
- If you need the enum values used by the seed data, see [Enums](/doc/backend-api/database/enums).
