...
description: Auth.js session strategy, dev/demo sign-in, and the authorization guard layers
order: 5
---
...
The full role model, permission flags, and franchisor-only access rules live in [RBAC](/doc/authentication/rbac). Use this page when you need the complete permission matrix rather than the auth plumbing.
