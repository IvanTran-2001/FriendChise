...
type Member = {
  ...
  memberRoles: { role: { id: string; name: string } }[];
};
      ...
      {members.map((m) => {
        ...
        return (
          <Link
            ...
            className="group"
          >
            <Card className="items-center text-center transition-shadow group-hover:shadow-md cursor-pointer">
              <CardHeader className="pb-0 items-center">
                <Avatar name={m.user.name} image={m.user.image} size="lg" />
              </CardHeader>
              <CardContent className="flex flex-col items-center gap-1.5 pb-4">
