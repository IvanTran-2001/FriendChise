...
export function MenuItemCard({ item }: { item: ResolvedMenuItem }) {
  ...
  return (
    <>
      <article className="flex w-full max-w-44 flex-col overflow-hidden rounded-2xl bg-white shadow-sm transition-shadow hover:shadow-md sm:max-w-none sm:w-57.5">
