...
const TASKS: [string, string, number, string][] = [
  // ── Frappes — purple ────────────────────────────────────────────────────────
  [
    "White Choc Biscoff Frappe", "#8B5CF6", 5,
  ...
  [
    "Strawberries & Cream Frappe", "#8B5CF6", 5,
  ...
  [
    "Deluxe Choc Chip Frappe", "#8B5CF6", 5,
  ...
  [
    "Mocha Frappe", "#8B5CF6", 5,
    "**Ingredients**\n• 1 full cup Ice\n• 1/4 cup Milk\n• 1 double shot Espresso (60ml)\n• 8x Chocolate Buttons\n• 4x small scoops Chocolate Frappe Powder\n\n**Method**\n1. Blend 35 sec.\n2. Top with Whipped Cream Swirl, Dark Chocolate Flakettes and Choc Drizzle.",
  ],
  [
    "Salted Caramel Frappe", "#8B5CF6", 5,
  ...
  [
    "Strawberry Matcha Frappe", "#8B5CF6", 5,
  ...
  [
    "Divine Triple Choc Doughssert", "#F97316", 10,
  ...
  [
    "Custard Caramel Supreme Doughssert", "#F97316", 10,
  ...
  [
    "Clean Ice Cream Machine", "#22C55E", 30,
...
async function main() {
  ...
  if (existing) {
    if (reset) {
      console.log(`  🗑 --reset: deleting org (id: ${existing.id}) and all related data...`);
