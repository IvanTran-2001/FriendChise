...
Read the setup flow in [docs/overview/getting-started.md](docs/overview/getting-started.md). It covers local Postgres, the required Supabase storage env vars, and the dev commands in order.
